        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {pillars.map((pillar) => {
            ...
            return (
              <Card
                key={pillar.id}
                className="relative flex flex-col justify-between overflow-hidden border-slate-200 bg-slate-50/50 p-6 transition-all hover:border-indigo-300 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900/60"
              >
                <div className="space-y-4">
                  {/* Icon & Tag */}
                  <div className="flex items-center justify-between">
                    <div className="flex size-12 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-md shadow-indigo-600/20">
                ...
                <div className="mt-8 border-t border-slate-200/80 pt-4 dark:border-slate-800">
                  {pillar.progress ? (
                    ...
                    <div className="space-y-1 rounded-lg border border-slate-200 bg-white p-3 text-xs shadow-sm dark:border-slate-800 dark:bg-slate-950">
