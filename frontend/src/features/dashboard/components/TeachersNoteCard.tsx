...
export function TeachersNoteCard() {
  return (
    <Card className="border-slate-100 bg-white p-6 shadow-xs dark:border-slate-800 dark:bg-slate-900">
      ...
      {/* Note Content Box */}
      <div className="relative mt-4 rounded-xl border border-indigo-100/60 bg-indigo-50/50 p-4 dark:border-slate-800 dark:bg-slate-800/40">
        <span className="absolute -top-3 left-4 font-serif text-3xl text-slate-300 select-none dark:text-slate-600">
          “
        </span>
        <div className="space-y-2 text-xs leading-relaxed text-slate-700 dark:text-slate-200">
          <p>
            ...
            <strong className="font-japanese text-indigo-900 dark:text-indigo-300">
              〜わけではない
            </strong>{' '}
            và{' '}
            <strong className="font-japanese text-indigo-900 dark:text-indigo-300">
