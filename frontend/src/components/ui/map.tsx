...
// Raw lazy component without mounting check - for use in Map component which handles mounting itself
...
function Map({
  ...
  return (
    <div className={cn('relative', mapClassName)}>
      {/* Skeleton - visible until map is ready */}
      <div
        className={cn(
          'absolute inset-0 z-10 animate-pulse rounded-md bg-gray-200 transition-opacity',
          isMapReady && 'pointer-events-none opacity-0',
        )}
